...
public class SeekBarDialogPreference extends DialogPreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        final ImageView iconPreview = (ImageView) view.findViewById(R.id.icon_preview);
        ...
        mSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                // change preview icon
                iconPreview.getLayoutParams().width = progress;
                iconPreview.getLayoutParams().height = progress;
    ...
    public void setProgress(int progress) {
        ...
        setSummary(mProgressTextSuffix == null ? Integer.toString(progress) : Integer.toString(progress).concat(mProgressTextSuffix.toString()));
    }
